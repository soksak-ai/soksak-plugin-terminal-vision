...
10. Pointer drag는 engine grid와 현재 surface rectangle로 정확한 cell/side gesture를 만듭니다. 요청은
    gesture id 하나 아래에서 직렬화합니다. Engine mouse tracking이 활성일 때 modifier 없는 pointer
